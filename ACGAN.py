...
class generator(nn.Module):
    ...
    def __init__(self, input_dim=100, output_dim=1, input_size=32, class_num=6):
...
class discriminator(nn.Module):
    ...
    def __init__(self, input_dim=1, output_dim=1, input_size=32, class_num=6):
    ...
    def train(self):
        ...
        for epoch in range(self.epoch):
            ...
            for iter, (x_, y_) in enumerate(self.data_loader):
                ...
                if self.gpu_mode:
                    x_, z_, y_vec_ = x_.cpu(), z_.cpu(), y_vec_.cpu()
