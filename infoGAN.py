...
class generator(nn.Module):
    ...
    def __init__(self, input_dim=100, output_dim=1, input_size=32, len_discrete_code=7, len_continuous_code=2):
...
class discriminator(nn.Module):
    ...
    def __init__(self, input_dim=1, output_dim=1, input_size=32, len_discrete_code=7, len_continuous_code=2):
...
class infoGAN(object):
    ...
    def visualize_results(self, epoch):
        ...
        print('data',samples.data.shape)
        t_sne_visualize(samples,4000,epoch)
        if self.gpu_mode:
